...
git clone [url]
# for example cloning the entire remote repo to local directory
git clone https://github.com/example/example [dir]
```
...
## Links
* [Git CheatSheet](https://www.codementor.io/@mattgoldspink/git-cheatsheet-du1088tr0)
